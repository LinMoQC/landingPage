...
import Functions from '@/views/front-pages/landing-page/functions.vue'
...
useIntersectionObserver(
  [refHome, refFunctions, refFeatures, refTeam, refContact, refFaq],
