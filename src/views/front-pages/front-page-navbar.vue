    ...
    <PerfectScrollbar :options="{ wheelPropagation: false }" class="h-100">
      ...
      <div>
        <div class="d-flex flex-column gap-y-4 pa-4">
          <RouterLink v-for="(item, index) in ['Home', 'Functions', 'Features', 'Team', 'FAQ', 'Contact us']"
                ...
                <ul class="mb-6">
                  <li v-for="listItem in item.navItems" :key="listItem.name" style="list-style: none;"
                    ...
                    <RouterLink :to="listItem.to" :target="item.listTitle === 'Page' ? '_self' : '_blank'"
                      ...
                      <VIcon icon="bx-circle" :size="10" class="me-2" />
      ...
      <VIcon id="navigation-drawer-close-btn" icon="bx-x" size="20" @click="sidebar = !sidebar" />
    </PerfectScrollbar>
  </VNavigationDrawer>
    ...
    <div class="front-page-navbar">
      <VAppBar :color="$vuetify.theme.current.dark ? 'rgba(255, 255, 255, 0.04)' : 'rgba(var(--v-theme-surface), 0.38)'"
        ...
        <div class="d-flex align-center">
          ...
          <div class="text-base align-center d-none d-md-flex">
            ...
            <span class="font-weight-medium cursor-pointer px-2 px-lg-4 py-2"
              ...
              Pages
              <VIcon icon="bx-chevron-down" size="16" class="ms-2" />
                    ...
                    <div class="nav-menu">
                      <div v-for="(item, index) in menuItems" :key="index">
                        ...
                        <ul>
                          <li v-for="listItem in item.navItems" :key="listItem.name" style="list-style: none;"
                            class="text-body-1 mb-4 text-no-wrap">
                            <RouterLink class="mega-menu-item" :to="listItem.to"
        ...
        <div class="d-flex gap-x-4">
          ...
          <VBtn v-if="$vuetify.display.lgAndUp" prepend-icon="bx-cart" variant="elevated" color="primary"
            href="https://themeselection.com/item/sneat-vuetify-vuejs-admin-template/" target="_blank"
            rel="noopener noreferrer">
            Purchase Now
          </VBtn>

          <VBtn v-else rounded icon variant="elevated" color="primary"
            href="https://themeselection.com/item/sneat-vuetify-vuejs-admin-template/" target="_blank"
            rel="noopener noreferrer">
            <VIcon icon="bx-cart" />
          </VBtn>
